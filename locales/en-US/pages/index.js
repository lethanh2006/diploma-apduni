module.exports = {
  question: "Which diploma or certificate do you want to verify?",
  prompt: "Please enter information to lookup",
  form: {
    fullname: "Full Name",
    ...
    cccd: "ID Card / CCCD",
    enter_cccd: "Enter ID Card number",
    student_id: "Student ID",
    enter_student_id: "Enter student ID",
    diploma_no: "Diploma No.",
    enter_diploma_no: "Enter diploma number",
    book_no: "Book Reg No.",
    example_book_no: "Example: TS25/{bookNumber}",
    search_button: "Verify Information"
  },
  table: {
    book_no: "Book Reg No.",
    ...
    fill_info_prompt: "Please fill in required fields to lookup",
    empty: "Empty"
  },
  messages: {
